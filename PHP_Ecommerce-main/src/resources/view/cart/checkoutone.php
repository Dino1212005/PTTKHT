...
?>
    ...
    ?>
        <form action="index.php?act=orderone " method="post">
            <div class="row">
                <div class="col">
                ...
                <div class="col">
                    ...
                    <h3 class="mb-5 fs-5 fw-light text-uppercase border-bottom">Your Shopping </h3>
                    <?php
                    if (isset($_GET['pro_id'])) {
                        $pro_id = $_GET['pro_id'];
                        $pro = queryonepro($pro_id);

                        $totalPrice = $pro['pro_price'] * $soluong;
                        $shipingPrice = 10;

                    ?>
                        <div>
                            <div class="mt-3 cart-item d-flex gap-3 border-bottom align-items-center w-100">
                                <input type="text" name="size" id="" value="<?= $size ?>" hidden>
                                <input type="text" name="color" id="" value="<?= $color ?>" hidden>
                                <input type="text" name="soluong" id="" value="<?= $soluong ?>" hidden>
                                <input name="pro_id" type="text" value="<?= $pro['pro_id'] ?>" hidden>
                                ...
                                <div class="d-flex flex-column flex-grow-1">
                                    ...
                                    <div class="d-flex align-items-end ">
                                        ...
                                        <input class="ps-2 w-25" type="number" name="" min="1" max="99" value="<?= $soluong ?>">
                                    </div>
                                </div>
                                <a
