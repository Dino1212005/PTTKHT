                ...
                <tr>
                    ...
                    <td>
                        <a href="indexadmin.php?act=delpro&pro_idxoa=<?php echo $pro_id ?>"><input type="button" name=""
                                class="mb-2 text-bg-secondary rounded" value="Xoá cứng"
                                onclick="return confirm('Bạn có chắc muốn xoá ?')" id=""></a>
                        <a href="indexadmin.php?act=khoiphuc_product&pro_idxoa=<?php echo $pro_id ?>"><input
                                type="button" name="" class="mb-2 text-bg-success rounded" value="Khôi phục"
                                onclick="return confirm('Bạn có chắc muốn khôi phục ?')" id=""></a>
                    </td>
                </tr>
