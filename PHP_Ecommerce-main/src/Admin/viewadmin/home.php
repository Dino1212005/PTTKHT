...
<main class="main-container">
    ...
    <div class="main-cards">
      ...
      ?>
        ...
        <div class="card">
            <div class="card-inner">
                <p class="text-primary"><a href="indexadmin.php?act=donhang" style="text-decoration: none;">PURCHASE
                        ORDERS</a></p>
      ...
      ?>
        ...
        <div class="card">
            <div class="card-inner">
                <p class="text-primary"><a href="indexadmin.php?act=listbl" style="text-decoration: none;">COMMENT</a>
                </p>
    ...
    const areaChartOptions = {
        series: [{
            ...
            foreach ($dh as $a) {
              extract($a);
            ?>
                    <?php echo $so_luong_donhang ?? $soluong ?? 0 ?>,
                    <?php } ?>
                ],
            },
            {
